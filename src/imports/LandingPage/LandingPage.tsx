...
function ButtonContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full px-4 md:px-0" data-name="Button Container">
      ...
      <div className="content-stretch flex gap-[8px] h-[48px] items-center justify-center px-[16px] relative rounded-[16px] shrink-0 w-full max-w-[220px]" data-name="Button">
...
function IntroSection() {
  return (
    <div className="relative w-full overflow-clip min-h-[600px] md:min-h-[890px]" data-name="Intro Section">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-[120px] md:h-[220px] w-full max-w-[854px] px-4" data-name="image 174">
        <img alt="" className="w-full h-full object-contain" src={imgImage174} />
      </div>
    </div>
  );
}
...
function VideoImage() {
  return (
    <div className="relative rounded-[16px] md:rounded-[32px] w-full max-w-[1115px] aspect-video" data-name="Video Image">
      <img alt="" className="absolute inset-0 object-cover pointer-events-none rounded-[16px] md:rounded-[32px] size-full" src={imgVideoImage} />
    </div>
  );
}
...
function VideoSection() {
  return (
    <div className="relative bg-white w-full flex flex-col gap-12 md:gap-[80px] items-center px-4 md:px-12 lg:px-[80px] py-16 md:py-24 lg:py-[120px] rounded-tl-[32px] md:rounded-tl-[64px] rounded-tr-[32px] md:rounded-tr-[64px]" data-name="Video Section">
      <Cotnet />
      <VideoImage />
    </div>
  );
...
function FeatureImageLarge() {
  return (
    <div className="min-h-[400px] md:h-[530px] w-full overflow-clip relative rounded-[20px] md:rounded-[30px] shrink-0" data-name="Feature Image Large">
      ...
      <FeatureTextGroup />
      <p className="absolute bottom-[54px] font-['Kalam:Bold',sans-serif] leading-[34px] left-1/2 md:left-[217px] -translate-x-1/2 md:translate-x-0 not-italic text-[#134d91] text-[24px] md:text-[28px] tracking-[-0.48px] translate-y-full whitespace-nowrap">Sam</p>
...
function Container1() {
  return (
    <div className="bg-white relative rounded-[20px] md:rounded-[24px] shrink-0 w-full md:flex-1" data-name="Container">
...
export default function LandingPage() {
  return (
    <div className="bg-white relative w-full min-h-screen" data-name="landing Page">
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 backdrop-blur-[8px] bg-[rgba(243,246,251,0.9)] flex items-center justify-between px-4 md:px-6 py-1 md:py-[4px] rounded-[20px] md:rounded-[30px] shadow-[0px_36.858px_13.981px_0px_rgba(227,233,254,0.02),0px_2.542px_5.084px_0px_rgba(186,201,250,0.15)] w-[95%] max-w-[1120px]" data-name="Header">
        <Frame />
        <Frame8 />
      </div>
