import svgPaths from "./svg-l1ngxxp6zl";
import imgLora1 from "./32264b1854d55ff26d5f28cf2aff116c87c1ae73.png";
...
import imgEllipse3 from "./a139f48be41e972fb015935e3c097f279d3ac328.png";
import imgFeatureImageSmall2 from "./cf31e812b350d794878316732de9dc42863611d4.png";
import imgFeatureImageSmall3 from "./a6c396695db2f4867d2b2cf94c4c4013fb4aa21a.png";
import imgEllipse4 from "./23e1832e25a4757f3626c813d4b9ceecb03d8216.png";
import imgFeatureImageSmall4 from "./81459e21086bbb45f043de724414eb6c6a228454.png";
import imgEllipse5 from "./ccc99f178aeb74701f11c6a2810f3ea67c01b0f1.png";
import imgFeatureImageSmall5 from "./7908e0c373350f1c767f51c81c8c63fccd42f554.png";
import imgEllipse6 from "./069843ce66119a26054928349493f18956890021.png";
import imgFeatureImageSmall6 from "./2ede8e04425e852843b64720e2e6023d1ed754cb.png";
import imgEllipse7 from "./a8268e7f0a8bf8713cbacf224699df9c9ef478ed.png";
import imgFeatureImageSmall7 from "./62bd3bf9f5ad3a92db4d110679abb47a4004ccbe.png";
import imgEllipse8 from "./ab7206f6cdddeeb361ab0c1a12e5048382d8f2c4.png";
import imgRectangle3 from "./dbeb2eb70d23fd0ba6a1408bdaa79f59657dc958.png";
...
import imgEllipse9 from "./a2ae2cf8cb232063b4086bffd3b1e88948abebc4.png";
import imgEllipse10 from "./fa84d9f484ac7ad0443c08af899733eba5803934.png";
...
import { imgFeatureImageSmall, imgGroup } from "./svg-pgeeg";
...
function Frame16() {
  return (
    <div className="font-semibold bg-[#eefdf3] content-stretch flex items-center justify-center px-[8px] py-[4px] relative rounded-[20px] shrink-0">
      <p className="font-['General_Sans',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#14a148] text-[14px] text-center whitespace-nowrap">AI Employees / Solution</p>
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center leading-[0] not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Marketing Lead</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function Frame17() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <div className="relative shrink-0 size-[40px]" data-name="Lora 1">
        <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgLora1} />
      </div>
      <Content />
    </div>
  );
...
function Container1() {
  return (
    <div className="bg-[#dbeafe] content-stretch flex gap-[16px] items-center p-[8px] relative rounded-[20px] shrink-0" data-name="Container">
...
function MaskGroup() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 h-[48.5px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[5.5px_-2px] mask-size-[40px_40px] ml-[-5.5px] mt-[2px] relative row-1 w-[53.5px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[173.21%] left-[-32.09%] max-w-none top-[-10.42%] w-[158.54%]" src={imgFeatureImageSmall1} />
        </div>
      </div>
    </div>
  );
...
function Mark() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Mark">
...
function Content1() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Strategist</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function Container2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center leading-[0] p-[8px] relative rounded-[20px] shrink-0" data-name="Container">
      <Mark />
      <Content1 />
    </div>
  );
...
function MaskGroup1() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 h-[42px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[2px_1px] mask-size-[40px_40px] ml-[-2px] mt-[-1px] relative row-1 w-[45px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[99.91%] left-[-0.01%] max-w-none top-[0.09%] w-[100.02%]" src={imgFeatureImageSmall2} />
        </div>
      </div>
    </div>
  );
...
function Sophie() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Sophie">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgEllipse3} width="40" />
      </div>
      <MaskGroup1 />
    </div>
  );
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI SEO/GEO Manager</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function MaskGroup2() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 h-[45px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[4px_2px] mask-size-[40px_40px] ml-[-4px] mt-[-2px] relative row-1 w-[50px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-full left-[2.54%] max-w-none top-[6.19%] w-[94.92%]" src={imgFeatureImageSmall3} />
        </div>
      </div>
    </div>
  );
...
function Clara() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Clara">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <g id="Ellipse 2">
            <circle cx="20" cy="20" fill="var(--fill-0, white)" r="20" />
            <circle cx="20" cy="20" fill="url(#paint0_linear_7_12831)" fillOpacity="0.8" r="20" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_12831" x1="37.3485" x2="32.7943" y1="40.4115" y2="-0.291847">
              <stop stopColor="#26C1FA" />
              <stop offset="0.899038" stopColor="#5ED4FF" />
            </linearGradient>
          </defs>
        </svg>
      </div>
...
function Content3() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Content Writer</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function MaskGroup3() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 h-[44px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[4px_1px] mask-size-[40px_40px] ml-[-4px] mt-[-1px] relative row-1 w-[47px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[100.35%] left-[-31.38%] max-w-none top-[4.19%] w-[165.69%]" src={imgFeatureImageSmall4} />
        </div>
      </div>
    </div>
  );
...
function Steve() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Steve">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgEllipse4} width="40" />
      </div>
      <MaskGroup3 />
    </div>
  );
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Visual Designer</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function MaskGroup4() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 h-[58px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[10px_2px] mask-size-[40px_40px] ml-[-10px] mt-[-2px] relative row-1 w-[64px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[358.88%] left-[-56.98%] max-w-none top-[-8.41%] w-[213.12%]" src={imgFeatureImageSmall5} />
        </div>
      </div>
    </div>
  );
...
function Theo() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Theo">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgEllipse5} width="40" />
      </div>
      <MaskGroup4 />
    </div>
  );
...
function Content5() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Video Producer</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function MaskGroup5() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.5px_1px] mask-size-[40px_40px] ml-[0.5px] mt-[-1px] relative row-1 size-[44px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-full left-[-10.68%] max-w-none top-[4.08%] w-[109.16%]" src={imgFeatureImageSmall6} />
        </div>
      </div>
    </div>
  );
...
function Sarah() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Sarah">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgEllipse6} width="40" />
      </div>
      <MaskGroup5 />
    </div>
  );
...
function Content6() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Social Media Manager</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function MaskGroup6() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 h-[54px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[10px_2px] mask-size-[40px_40px] ml-[-10px] mt-[-2px] relative row-1 w-[60px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }} data-name="Feature Image Small">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[173.5%] left-[-36.83%] max-w-none top-[-28.37%] w-[173.67%]" src={imgFeatureImageSmall7} />
        </div>
      </div>
    </div>
  );
...
function Elena() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Elena">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgEllipse7} width="40" />
      </div>
      <MaskGroup6 />
    </div>
  );
...
function Content7() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Ads Manager</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function MaskGroup7() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1" data-name="Mask group">
      <div className="col-1 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[5px_2px] mask-size-[40px_40px] ml-[-5px] mt-[-2px] relative row-1 size-[50px]" style={{ maskImage: `url('${imgFeatureImageSmall}')` }}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[120.44%] left-[-48.18%] max-w-none top-0 w-[193.05%]" src={imgRectangle3} />
        </div>
      </div>
    </div>
  );
...
function Nick() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid mix-blend-luminosity place-items-start relative shrink-0" data-name="Nick">
      <div className="col-1 ml-0 mt-0 relative row-1 size-[40px]">
        <div className="absolute inset-[-27.36%_-55.84%_-84.32%_-55.84%]">
          <img loading="lazy" decoding="async" alt="" className="block max-w-none size-full" height="84.673" src={imgEllipse8} width="84.673" />
        </div>
      </div>
      <MaskGroup7 />
    </div>
...
function Content8() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 whitespace-nowrap" data-name="Content">
      <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center mb-[-2px] relative shrink-0 text-[#1f2937] text-[14px] tracking-[0.21px]">
        <p className="leading-[20px]">AI Analyst</p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center mb-[-2px] relative shrink-0 text-[#6b7280] text-[12px]">
...
function Container() {
  return (
    <div className="bg-[#f9fafc] content-stretch flex gap-[20px] items-center overflow-x-auto overflow-y-clip px-[12px] py-[4px] relative rounded-[24px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0 w-[510px]" data-name="Container">
      <Container1 />
      <Container2 />
      <Container3 />
      <Container4 />
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center not-italic relative shrink-0 text-center w-full">
      <p className="font-['Satoshi',sans-serif] font-bold leading-[0] min-w-full relative shrink-0 text-[#1f2937] text-[56px] tracking-[-1.4px] w-[min-content]">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#6b7280] text-[18px] w-[546px]">Lora crafts a tailored marketing strategy from your goals. She breaks down tasks, assigns them to the right team members, and ensures every action stays true to your brand voice.</p>
    </div>
  );
}
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center justify-center px-[80px] py-[40px] relative size-full">
          <div className="absolute h-[901px] left-0 top-0 w-full max-w-[1280px] px-4" data-name="image 190">
            <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage190} />
          </div>
          <div className="h-[660px] pointer-events-none relative rounded-[32px] shrink-0 w-[1020px]" data-name="image 189">
            <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover rounded-[32px] size-full" src={imgImage189} />
...
function Container10() {
  return (
    <div className="content-stretch flex gap-[12px] items-baseline relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-[1_0_0] flex-col font-['General_Sans',sans-serif] font-medium justify-center leading-[0] min-w-px not-italic relative text-[#1f2937] text-[16px]">
    ...
    <div className="bg-white flex-[1_0_0] h-full min-w-px relative z-[2]">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[32px] items-center px-[40px] py-[32px] relative size-full">
          <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#1f2937] text-[24px] text-center whitespace-nowrap">
...
function Container16() {
  return (
    <div className="bg-[#eefdf3] content-stretch flex gap-[8px] items-start px-[16px] py-[12px] relative rounded-[80px] shrink-0" data-name="Container">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[22px] not-italic relative shrink-0 text-[#14a148] text-[16px] w-[411px]">Coordinates all AI Employees for execution in your voice</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="bg-[#eef4ff] content-stretch flex gap-[8px] items-start px-[16px] py-[12px] relative rounded-[80px] shrink-0" data-name="Container">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[22px] not-italic relative shrink-0 text-[#1877f2] text-[16px] whitespace-nowrap">Analyze performance across all channels</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="bg-[#fce7f3] content-stretch flex gap-[8px] items-start px-[16px] py-[12px] relative rounded-[80px] shrink-0" data-name="Container">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[22px] not-italic relative shrink-0 text-[#ec4899] text-[16px] whitespace-nowrap">Track competitors and market shifts in real-time</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="bg-[#f2e7ff] content-stretch flex gap-[8px] items-start px-[16px] py-[12px] relative rounded-[80px] shrink-0" data-name="Container">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[22px] not-italic relative shrink-0 text-[#9131ea] text-[16px] whitespace-nowrap">{`Share daily insights & Plan next marketing`}</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="bg-[#fffaea] content-stretch flex gap-[8px] items-start px-[16px] py-[12px] relative rounded-[80px] shrink-0" data-name="Container">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[22px] not-italic relative shrink-0 text-[#d77504] text-[16px] whitespace-nowrap">{`Discover trends, ideas & winning strategies instantly`}</p>
    </div>
  );
}
    ...
    <div className="bg-white relative shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="font-bold content-stretch flex flex-col gap-[48px] items-center p-[80px] relative size-full">
          <p className="font-['Satoshi',sans-serif] font-bold leading-[48px] not-italic relative shrink-0 text-[#1f2937] text-[40px] text-center tracking-[-0.8px] whitespace-nowrap">Old vs New AI Way!</p>
          <Frame19 />
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex items-center pr-[4px] relative shrink-0">
      <div className="mr-[-4px] relative shrink-0 size-[12px]" data-name="Component 2">
        <div className="absolute aspect-[100/100] left-0 right-0 top-0">
          <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="12" src={imgEllipse9} width="12" />
        </div>
        <MaskGroup8 />
      </div>
      <div className="mr-[-4px] relative rounded-[50px] shrink-0 size-[12px]" data-name="Component 3">
        ...
        <div className="absolute aspect-[100/100] left-0 right-0 top-0">
          <img loading="lazy" decoding="async" alt="" className="absolute block inset-0 max-w-none size-full" height="12" src={imgEllipse10} width="12" />
        </div>
        <MaskGroup9 />
      </div>
    </div>
...
function Frame31() {
  return (
    <div className="bg-[#f9fafc] content-stretch flex gap-[4px] items-center overflow-clip px-[4px] py-[2px] relative rounded-[20px] shrink-0">
      <Frame32 />
      <div className="flex flex-col font-['Bricolage_Grotesque',sans-serif] font-normal font-normal justify-center leading-[0] relative shrink-0 text-[#6b7280] text-[12px] tracking-[-0.3px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14, 'wdth' 100" }}>
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#1f2937] text-[14px] w-[min-content]">
    ...
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[32px] items-center pl-[8px] pr-[24px] py-[12px] relative size-full">
          <AvatarWithTitle />
          <div className="absolute bottom-[12px] flex flex-col font-['General_Sans',sans-serif] font-medium justify-center leading-[0] not-italic right-[60px] text-[#6b7280] text-[12px] translate-x-full translate-y-1/2 whitespace-nowrap">
    ...
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[12px] relative size-full">
          ...
          <Frame34 />
          <div className="absolute bottom-[12px] flex flex-col font-['General_Sans',sans-serif] font-medium justify-center leading-[0] not-italic right-[57px] text-[#6b7280] text-[12px] translate-x-full translate-y-1/2 whitespace-nowrap">
...
function Container25() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[36px] px-[8px] py-[12px] rounded-[16px] top-[365px] w-[400px]" data-name="Container">
      ...
      <div className="bg-white content-stretch flex gap-[4px] h-[32px] items-center justify-center px-[24px] relative rounded-[120px] shrink-0" data-name="Button">
        <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[120px]" />
        <p className="font-['Satoshi',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#111827] text-[12px] tracking-[0.3px] whitespace-nowrap">View</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Description Section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-center leading-[0] not-italic p-[40px] relative size-full text-center">
          <div className="flex flex-col font-['Satoshi',sans-serif] font-bold justify-center relative shrink-0 text-[#14a148] text-[24px] tracking-[-0.5px] w-full">
...
function Content14() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 whitespace-nowrap" data-name="Content">
      <p className="font-['Satoshi',sans-serif] font-bold leading-[20px] relative shrink-0 text-[#101828] text-[14px] tracking-[0.21px]">New trending topic</p>
...
function Content15() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 whitespace-nowrap" data-name="Content">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#155dfc] text-[12px]">30 new growth posts detected</p>
    </div>
  );
}
...
function Content17() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 whitespace-nowrap" data-name="Content">
      ...
      <p className="font-['General_Sans',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e17100] text-[12px]">12 ideas ready</p>
    </div>
  );
}
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Description Section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-center leading-[0] not-italic p-[40px] relative size-full text-center">
          ...
          <div className="flex flex-col font-['General_Sans',sans-serif] font-medium justify-center relative shrink-0 text-[#6b7280] text-[0px] w-full">
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[48px] items-center p-[80px] relative size-full">
          <p className="font-['Satoshi',sans-serif] font-bold leading-[48px] not-italic relative shrink-0 text-[#1f2937] text-[40px] text-center tracking-[-0.8px] w-[274px]">What you get it</p>
          <Frame26 />
        </div>
      </div>
    </div>
...
function Cotnet() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center not-italic relative shrink-0 text-center" data-name="Cotnet">
      <p className="font-['Satoshi',sans-serif] font-bold leading-[48px] relative shrink-0 text-[#1f2937] text-[40px] tracking-[-0.8px] whitespace-nowrap">Frequently Asked Questions</p>
...
function Container40() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-w-px not-italic relative" data-name="Container">
      <p className="font-['Satoshi',sans-serif] font-bold h-[22px] leading-[28px] opacity-88 relative shrink-0 text-[#1f2937] text-[20px] w-full">What is Loraloops AI employee?</p>
    ...
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[32px] items-center p-[24px] relative size-full">
          <p className="flex-[1_0_0] font-['Satoshi',sans-serif] font-bold h-[22px] leading-[28px] min-w-px not-italic opacity-88 relative text-[#1f2937] text-[20px]">What can I use Loraloop AI employees for?</p>
          <Frame13 />
        </div>
      </div>
    </div>
...
function Container42() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[32px] items-center p-[24px] relative size-full">
          <p className="flex-[1_0_0] font-['Satoshi',sans-serif] font-bold h-[22px] leading-[28px] min-w-px not-italic opacity-88 relative text-[#1f2937] text-[20px]">Can AI employees replace human employees?</p>
          <Frame14 />
        </div>
      </div>
    </div>
...
function TextGroupVertical() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center not-italic relative shrink-0 text-center w-full" data-name="Text Group Vertical">
      <p className="font-['Satoshi',sans-serif] font-bold leading-[48px] relative shrink-0 text-[40px] text-white tracking-[-0.8px] w-full">AI marketing Team that Never sleep</p>
...
function Frame39() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-[128px] w-full max-w-[1280px] px-4">
      <div className="content-stretch flex flex-col gap-[40px] items-center pb-[40px] px-[80px] relative shrink-0 w-full max-w-[1280px] px-4" data-name="header">
        <Frame40 />
        <Frame15 />
      </div>
      <Frame42 />
