import svgPaths from "./svg-y68wujngrg";
...
import { imgGroup } from "./svg-lajbs";
...
export default function DesignLora() {
  return (
    <div className="bg-black content-stretch flex items-center justify-center pb-[80px] pt-[48px] px-[80px] relative size-full" data-name="Design Lora">
      <Container />
    </div>
  );
}