...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      ...
      <a
        href="/app/signup"
        className="bg-[#1877f2] content-stretch flex gap-[4px] h-[40px] items-center justify-center px-[20px] relative rounded-[120px] shrink-0"
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <a
        href="/app/signin"
        className="bg-white flex-[1_0_0] h-[40px] min-w-px relative rounded-[120px] flex items-center justify-center"
        data-name="Signin"
      >
        <p className="font-['Satoshi:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-[#0f172a] whitespace-nowrap">Signin</p>
      </a>
      <a
        href="/app/signup"
        className="bg-[#1877f2] flex-[1_0_0] h-[40px] min-w-px relative rounded-[120px] flex items-center justify-center"
        data-name="Get Started"
      >
        <p className="font-['Satoshi:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Get Started</p>
      </a>
