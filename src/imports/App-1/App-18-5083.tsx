import svgPaths from "./svg-wdye6a258r";
...
import { imgFeatureImageSmall, imgGroup, imgColor } from "./svg-7x6kx";
...
export default function App() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[80px] items-center justify-center pb-[80px] px-[80px] relative size-full" data-name="App">
      <Solution />
      <Frame />
    </div>
  );
