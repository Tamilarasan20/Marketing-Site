import imgImage193 from "./0dc2ad5c703cc1cfd43131b5db9a939855b81e73.png";
import imgImage194 from "./ea20da38ecee605f940a9169ebabca1f1f80d805.png";
import imgImage199 from "./4cac83e72605076996a10405504859a2061d849a.png";
import imgImage192 from "./b9bebe8e72987e4739aa1ba92a071ec8e6028b8e.png";
import imgImage198 from "./510f409ee14c0ac6edf22076fa17aaade0827adb.png";
import imgImage200 from "./bc63bd75c50f7195ee67c12ba18bae0546116262.png";
import imgImage195 from "./25875f634bb5955138c2415b5a761be9c504b422.png";
import imgImage196 from "./e66b233b45ec83ca8249a27fcdde16d0cb957be3.png";
import imgImage197 from "./4def1c376fe3407da459dc5c0acbe8552485afd4.png";
...
function Cotnet() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center not-italic relative shrink-0 text-center w-full max-w-[740px] px-4" data-name="Cotnet">
      <p style={{ fontWeight: 900 }} className="font-['Satoshi',sans-serif] font-bold leading-[48px] relative shrink-0 text-[40px] text-white tracking-[-0.8px] w-full">AI employees that run your marketing end to end even while you sleep.</p>
...
function FeatureTextGroup() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[120px] mt-[440px] relative row-1 w-[420px]" data-name="Feature Text Group">
      <TextGroupVertical />
      <LearnMoreContainer />
    </div>
  );
...
function FeatureTextGroup1() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[700px] mt-[440px] relative row-1 w-[420px]" data-name="Feature Text Group">
      <TextGroupVertical1 />
      <LearnMoreContainer1 />
    </div>
  );
...
function FeatureTextGroup2() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[700px] mt-[1580px] relative row-1 w-[420px]" data-name="Feature Text Group">
      <TextGroupVertical2 />
      <LearnMoreContainer2 />
    </div>
  );
...
function FeatureTextGroup3() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[120px] mt-[40px] relative row-1 w-[578px]" data-name="Feature Text Group">
      <TextGroupVertical3 />
      <LearnMoreContainer3 />
    </div>
  );
...
function FeatureTextGroup4() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[120px] mt-[1580px] relative row-1 w-[420px]" data-name="Feature Text Group">
      <TextGroupVertical4 />
      <LearnMoreContainer4 />
    </div>
  );
...
function FeatureTextGroup5() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[120px] mt-[2155px] relative row-1" data-name="Feature Text Group">
      <TextGroupVertical5 />
      <LearnMoreContainer5 />
    </div>
  );
...
function FeatureTextGroup6() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start justify-center ml-[32px] mt-[32px] relative row-1 w-full" data-name="Feature Text Group">
      <TextGroupVertical6 />
      <LearnMoreContainer6 />
    </div>
  );
...
function FeatureTextGroup7() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] h-[380px] items-start ml-[32px] mt-[32px] relative row-1 w-full" data-name="Feature Text Group">
      <TextGroupVertical7 />
      <LearnMoreContainer7 />
    </div>
  );
...
function FeatureHighlight() {
  return (
    <div className="relative shrink-0 w-full" data-name="Feature Highlight">
      <div className="gap-x-[40px] gap-y-[40px] grid grid-cols-1 md:grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(5,fit-content(100%))] leading-[0] px-[80px] relative size-full">
        <Group1 />
        <Group2 />
        <Group7 />
        <Group />
...
export default function MainContent() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[80px] items-center py-[120px] relative size-full" data-name="Main Content">
      <Cotnet />
      <FeatureHighlight />
