import svgPaths from "./svg-zrb3yp5qc4";
...
import { imgFeatureImageSmall, imgGroup, imgColor } from "./svg-ax472";
...
function GoogleAds1() {
  return (
    <div className="absolute inset-[3.13%_0_5.5%_0]" data-name="Google Ads">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 38.3757">
        <g id="Google Ads">
...
function Frame50() {
  return (
    <div className="content-stretch flex gap-[32px] items-start relative shrink-0">
      <div className="bg-[#1877f2] content-stretch flex gap-[8px] h-[48px] items-center justify-center px-[16px] relative rounded-[120px] shrink-0 w-[114px]" data-name="Button">
...
function PriceAndFaq() {
  return (
    <div className="bg-black relative shrink-0 w-full" data-name="Price and FAQ">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[120px] items-center pl-[45px] pr-[47px] py-[80px] relative size-full">
          <Frame9 />
...
function MainContent() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[80px] items-center overflow-clip pt-[80px] relative shrink-0 w-full" data-name="Main Content">
      <CallToActionGroup />
...
export default function Frame37() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full">
      <App />
      <PriceAndFaq />
      <div className="bg-white content-stretch flex flex-col gap-[48px] items-center overflow-clip py-[80px] relative shrink-0 w-full" data-name="Price and FAQ">
        <Cotnet2 />
        <Container95 />
      </div>
      <MainContent />
