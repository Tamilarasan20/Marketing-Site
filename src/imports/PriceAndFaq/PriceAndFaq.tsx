import svgPaths from "./svg-tvjq9to2yn";
...
function Frame9({ className }: { className?: string }) {
  return (
...
export default function PriceAndFaq() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[120px] items-center pl-[45px] pr-[47px] py-[80px] relative size-full" data-name="Price and FAQ">
      <Frame6 />
      <Frame9 />
    </div>
  );
