      ...
      <div className="max-w-[860px] px-4 md:px-8 mx-auto">
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-3">
            <p className="font-['Satoshi:Bold',sans-serif] leading-[56px] text-[#101828] text-5xl tracking-[-1.2px]">Terms & Data Deletion</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <p>For any questions about these terms or data deletion:</p>
              <ul className="list-disc pl-6 flex flex-col gap-1">
