...
export default function DataDeletion() {
  usePageMeta("Data Deletion | Loraloop", "Request deletion of your personal data from Loraloop in accordance with applicable privacy regulations.");
  return (
      ...
      <div className="max-w-[860px] px-4 md:px-8 mx-auto">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">1. Your Right to Deletion</p>
          ...
          {/* 2. What Gets Deleted */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">2. What Data Gets Deleted</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <p>When you submit a verified deletion request, we permanently remove:</p>
              <ul className="list-disc pl-6 flex flex-col gap-1">
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Account data</span> — your profile, name, email, password hash, billing details (excluding records we are legally required to keep for tax/accounting).</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Connected platform data</span> — Facebook Pages, Instagram Business accounts, ad accounts, page tokens, audience data, post insights, and any other data pulled from Meta or other connected platforms.</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Content & AI data</span> — uploaded files, brand assets, prompts, briefs, AI-generated text/images/videos, drafts, schedules, and campaign history.</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Usage & analytics</span> — your activity logs, preferences, and engagement records.</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Integration tokens</span> — OAuth tokens, API keys, refresh tokens, and webhook subscriptions are immediately revoked.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">3. How to Request Deletion</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <p>You can submit a deletion request using either of these methods:</p>

              <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-lg mt-2">Option A — Email Request (Recommended)</p>
              ...
              <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-lg mt-2">Option B — In-App Deletion</p>
              ...
              <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-lg mt-2">Option C — Removal via Facebook Settings</p>
          ...
          {/* 4. Verification */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">4. Verification of Identity</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <p>
          ...
          {/* 5. Timeline */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">5. Processing Timeline</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <ul className="list-disc pl-6 flex flex-col gap-1">
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Within 24–72 hours:</span> We acknowledge receipt of your request and revoke active integration tokens.</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Within 7 days:</span> All live data, including connected Meta data, is removed from production systems.</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Within 30 days:</span> Encrypted backups are purged during the next scheduled rotation. You receive a final confirmation email.</li>
                <li><span className="text-[#101828] font-['Satoshi:Bold',sans-serif]">Up to 90 days:</span> Data fully removed from all disaster-recovery archives.</li>
              </ul>
            </div>
          </div>
          ...
          {/* 6. Retained */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">6. Data We May Retain</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
          ...
          {/* 7. Meta-specific */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">7. Meta / Facebook Data Deletion</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <p>
          ...
          {/* 8. Children */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">8. Children's Data</p>
            <div className="flex flex-col gap-3 font-['General_Sans:Medium',sans-serif] text-[#374151] text-base leading-7">
              <p>
          ...
          {/* 9. Contact */}
          <div className="flex flex-col gap-4">
            <p className="font-['Satoshi:Bold',sans-serif] text-[#101828] text-2xl leading-8">9. Contact & Data Protection</p>
