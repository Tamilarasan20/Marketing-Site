      ...
      <div className="max-w-[1280px] px-4 sm:px-6 md:px-20 mx-auto">
        <div className="flex flex-col gap-[88px]">
          <div className="flex flex-col gap-14">
            <p className="font-['Satoshi:Bold',sans-serif] leading-tight text-[#101828] text-4xl md:text-5xl tracking-[-1.2px]">About Loraloop</p>
          ...
          <div className="flex flex-col gap-10">
            <p className="font-['Satoshi:Bold',sans-serif] leading-tight text-[#101828] text-3xl md:text-4xl tracking-[-0.54px]">What Makes Loraloop Different</p>
          ...
          <div className="bg-[#101828] rounded-[40px] px-8 py-10">
            <div className="flex flex-col gap-2">
              <p className="font-['Satoshi:Bold',sans-serif] leading-tight text-3xl md:text-[40px] text-white tracking-[-0.8px]">Our Vision</p>
