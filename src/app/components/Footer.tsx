        ...
        <div className="flex flex-col gap-12 md:gap-16">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 xl:grid-cols-5 xl:gap-12">
            ...
            <div className="flex flex-col gap-[13px] items-center text-center sm:items-start sm:text-left">
              ...
              <Link
                to="/tools"
                className="font-['General_Sans',sans-serif] font-medium leading-[22px] text-[#1877f2] text-sm sm:text-base hover:underline transition-colors break-words"
              >
                View all tools →
              </Link>
            </div>
            ...
            <div className="flex flex-col gap-[13px] items-center text-center sm:items-start sm:text-left">
              ...
              <Link to="/blog" className="font-['General_Sans',sans-serif] font-medium leading-[22px] text-[#1877f2] text-sm sm:text-base hover:underline transition-colors break-words">
                View all posts →
              </Link>
            </div>
            ...
            <div className="flex flex-col gap-[14px] items-center text-center sm:items-start sm:text-left">
              ...
              <Link to="/data-deletion" className="font-['General_Sans',sans-serif] font-medium leading-[22px] text-[#374151] text-sm sm:text-base hover:text-[#1877f2] transition-colors break-words">User Data Deletion</Link>
              <Link to="/contact" className="font-['General_Sans',sans-serif] font-medium leading-[22px] text-[#374151] text-sm sm:text-base hover:text-[#1877f2] transition-colors break-words">Contact Us/Support</Link>
              <p className="font-['General_Sans',sans-serif] font-medium leading-[22px] text-[#9ca3af] text-sm sm:text-base break-words">Become Affiliate (Soon)</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8 items-center border-t border-[#e5e7eb] pt-10">
            <div className="flex gap-4 justify-center">
              <a href="https://www.linkedin.com/company/loraloop/" target="_blank" rel="noopener noreferrer" className="rounded-xl w-12 h-12 flex items-center justify-center hover:bg-gray-100 transition-colors">
                <img loading="lazy" decoding="async" alt="LinkedIn" className="w-9 h-9 object-cover" src={imgLogos} />
              </a>
              <a href="https://www.instagram.com/loraloop_ai?igsh=YXR6bnpjcXB3bXFi" target="_blank" rel="noopener noreferrer" className="rounded-xl w-12 h-12 flex items-center justify-center hover:bg-gray-100 transition-colors">
                <img loading="lazy" decoding="async" alt="Instagram" className="w-9 h-9 object-cover" src={imgLogos1} />
              </a>
              <a href="https://x.com/TKtamilarasan2" target="_blank" rel="noopener noreferrer" className="rounded-xl w-12 h-12 flex items-center justify-center hover:bg-gray-100 transition-colors">
                <img loading="lazy" decoding="async" alt="X (Twitter)" className="w-9 h-9 object-cover" src={imgLogos2} />
              </a>
            </div>
